  ...
  const handleMessage = (event) =>
    __awaiter(this, void 0, void 0, function* () {
      ...
      if (message.type === 'WEBPAGE_TUNNEL_HANDSHAKE') {
        (_a = event.source) === null || _a === void 0
          ? void 0
          : _a.postMessage(
              {
      ...
      if (message.type === 'WEBPAGE_TUNNEL_REQUEST') {
        ...
        if (!method || !methods[method]) {
          (_b = event.source) === null || _b === void 0
            ? void 0
            : _b.postMessage(
                {
        ...
        try {
          ...
          (_c = event.source) === null || _c === void 0
            ? void 0
            : _c.postMessage(
                {
                  type: 'WEBPAGE_TUNNEL_RESPONSE',
          ...
          (_d = event.source) === null || _d === void 0
            ? void 0
            : _d.postMessage(
                {
                  type: 'WEBPAGE_TUNNEL_RESPONSE',
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
          ...
          for (let retry = 0; retry < maxRetries; retry++) {
            ...
            for (const iframe of Array.from(parentIframes)) {
              ...
              if (
                (_a = iframe.src) === null || _a === void 0 ? void 0 : _a.startsWith(this.server)
              ) {
      ...
      for (const iframe of iframes) {
        if ((_b = iframe.src) === null || _b === void 0 ? void 0 : _b.startsWith(this.server)) {
          ...
          const isLoaded =
            ((_c = iframe.contentDocument) === null || _c === void 0 ? void 0 : _c.readyState) ===
            'complete';
          if (!isLoaded) {
          ...
          for (const mutation of mutations) {
            for (const node of Array.from(mutation.addedNodes)) {
              if (
                ...
                ((_a = node.src) === null || _a === void 0 ? void 0 : _a.startsWith(this.server))
              ) {
